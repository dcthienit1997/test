...
@ConfigurationProperties("blueprint.error.handling")
@Component
public class ErrorHandlingProperties {
  ...
  private DefaultErrorCodeStrategy defaultErrorCodeStrategy =
    DefaultErrorCodeStrategy.ALL_CAPS;
  ...
  public void setFullStacktraceClasses(
    List<Class<? extends Throwable>> fullStacktraceClasses
  ) {
  ...
  public void setFullStacktraceHttpStatuses(
    List<String> fullStacktraceHttpStatuses
  ) {
  ...
  public void setDefaultErrorCodeStrategy(
    DefaultErrorCodeStrategy defaultErrorCodeStrategy
  ) {
